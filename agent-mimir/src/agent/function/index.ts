...
// import {  DefaultHumanMessageSerializerImp, PlainTextMessageSerializer, deserializeWithFunction } from "../../parser/plain-text-parser/index.js";
...
//         const transformMemory = new TransformationalMemory(innerMemory, new FunctionCallAiMessageSerializer(), new DefaultHumanMessageSerializerImp());
