...
import { Agent, AgentFactory, AgentWorkspace, IntermediateAgentMessage } from "../agent-manager/index.js";
...
class StaticAgent implements Agent {
    ...
    async *call(): AsyncGenerator<IntermediateAgentMessage, {
        message: {
            checkpointId: string;
            type: "agentResponse";
            output: {
    ...
    async *handleCommand(): AsyncGenerator<IntermediateAgentMessage, {
        message: {
            checkpointId: string;
            type: "agentResponse";
            output: {
...
class CapturingFactory implements AgentFactory {
    pluginsPassed: PluginFactory[] | undefined;
